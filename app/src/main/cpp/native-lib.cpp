...
extern "C" jint Java_com_example_puushswitch_MainActivity_ReceivePushSwitchValue(JNIEnv *env, jobject thiz) {
    int retval;
...
extern "C" jint Java_com_example_puushswitch_MainActivity_DeviceOpen(JNIEnv *env, jobject thiz) {
    int retval;
    retval=fpga_push_open();
}


extern "C" jint Java_com_example_puushswitch_MainActivity_DeviceClose(JNIEnv *env, jobject thiz) {
    int retval;
